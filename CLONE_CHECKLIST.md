...
|---|---|---|
| New domain | GoDaddy / purchase | `carefreehomesforsale.com` |
...
git remote set-url origin https://github.com/aiagent322/carefree-homes-for-sale
...
| Find | Replace with |
|---|---|
| `wickenburghorseproperty.com` | `carefreehomesforsale.com` |
| `wickenburg-horse-property.pages.dev` | `carefree-homes-for-sale.pages.dev` |
| `aiagent322/wickenburg-horse-property` | `aiagent322/carefree-homes-for-sale` |
...
"url": "https://carefreehomesforsale.com/",
...
2. Connect to new GitHub repo (`aiagent322/carefree-homes-for-sale`)
